  ...
  return (
    <Container className="pb-16 pt-20 text-center lg:pt-32">
      <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl">
        The{' '}
        <span className="relative whitespace-nowrap text-violet-800">
          <svg
            aria-hidden="true"
            viewBox="0 0 418 42"
            className="absolute left-0 top-2/3 h-[0.58em] w-full fill-violet-900/60"
          ...
          <span className="relative">ONE solution</span>
        </span>{' '}
      ...
      <div className="mt-10 flex justify-center gap-x-6">
        ...
        <Button
          href="https://youtu.be/KOTJymkDcDw"
          target="blank"
          variant="outline"
        >
          <svg
            aria-hidden="true"
            className="h-3 w-3 flex-none fill-violet-700 group-active:fill-current"
          >
